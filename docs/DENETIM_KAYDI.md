...
Manuel modda bir araç çağrıldığında AgentProbe `reports/manual/audit.jsonl` dosyasına bir denetim kaydı ekler. Bu kayıt araç türünü, kaynak kimliğini, izin kararını ve araç sonucunun SHA-256 özetini içerir.
